...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Siesta02")
OWNER_NAME = getenv("OWNER_NAME", "aye_ujjwal")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "Dare_Devils_01")
PROJECT_NAME = getenv("PROJECT_NAME", "VCPlayBot2.0")
SOURCE_CODE = getenv("SOURCE_CODE", "@repoofseista")
